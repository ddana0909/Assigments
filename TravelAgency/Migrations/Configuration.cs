...
{
    internal sealed class Configuration : DbMigrationsConfiguration<TravelAgency.Models.TravelAgencyEntities>
    {
        ...
        protected override void Seed(TravelAgency.Models.TravelAgencyEntities db)
        {
